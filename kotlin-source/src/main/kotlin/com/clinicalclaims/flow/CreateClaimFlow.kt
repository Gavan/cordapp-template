...
/**
 * This flow allows two parties (the [Initiator] and the [Acceptor]) to come to an agreement about the Claim encapsulated
 * within an [ClaimState].
 *
 * In our simple example, the [Acceptor] always accepts a valid Claim.
 *
...
object CreateClaimFlow {
     ...
     */
    class Initiator(val claim: ClaimState,
         ...
         */
        companion object {
            object GENERATING_TRANSACTION : ProgressTracker.Step("Generating transaction based on new Claim.")
        ...
        override fun call() : SignedTransaction {
            ...
            val txCommand = Command(ClaimContract.Commands.Create(), claim.participants)
            val unsignedTx = TransactionType.General.Builder(notary).withItems(claim, txCommand)
